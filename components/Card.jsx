    ...
    <section id="FEACHER" className="bg-white dark:bg-gray-900">
      <div className="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
        <div className="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
          ...
          >
            Chez Landwind, nous nous concentrons sur les marchés où la
            technologie, l'innovation, et le capital peut libérer de la valeur à
            long terme et stimuler la croissance économique.
          </p>
        </div>
        <div
          data-aos="fade-up"
        ...
        >
          <div className="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            ...
            <ul role="list" className="mb-8 space-y-4 text-left">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>Pas d'installation ni de frais cachés</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
                  className="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400"
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>
                  Premium support: <span className="font-semibold">6 mois</span>
                </span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
          ...
          <div className="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            ...
            <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
              Pertinent pour plusieurs utilisateurs, support étendu et premium.
            </p>
            <div className="flex items-baseline justify-center my-8">
          ...
          <div className="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            ...
            <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
              Idéal pour les utilisations à grande échelle et les droits de
              redistribution étendus.
            </p>
            <div className="flex items-baseline justify-center my-8">
            ...
            <ul role="list" className="mb-8 space-y-4 text-left">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>
                  Premium support:{" "}
                  <span className="font-semibold">36 mois</span>
                </span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
