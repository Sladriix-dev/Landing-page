    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="items-center max-w-screen-xl px-4 py-8 mx-auto lg:grid lg:grid-cols-4 lg:gap-16 xl:gap-24 lg:py-24 lg:px-6">
        <div className="col-span-2 mb-8">
          ...
          >
            Reconnu par plus de 600 millions d'utilisateurs et 10 000 équipes
          </h2>
          <p
            data-aos="fade-right"
            className="font-light text-gray-500 sm:text-xl dark:text-gray-400"
          >
            Nos normes rigoureuses de sécurité et de conformité sont au cœur de
            tout ce que nous faisons. Nous travaillons sans relâche pour vous
        ...
        <div className="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
          <div data-aos="fade-right">
            ...
            <p className="font-light text-gray-500 dark:text-gray-400">
              Pour Landwind, sans aucun temps d'arrêt pour maintenance with zero
          ...
          <div data-aos="fade-left">
            ...
            <p className="font-light text-gray-500 dark:text-gray-400">
              Reconnu par plus de 600 millions d'utilisateurs et 10000 équipes.
            </p>
          </div>
          <div data-aos="fade-right">
            <svg
            ...
            <p className="font-light text-gray-500 dark:text-gray-400">
              Utilisez Landwind pour créer vos sites
            </p>
          </div>
          <div data-aos="fade-left">
            <svg
